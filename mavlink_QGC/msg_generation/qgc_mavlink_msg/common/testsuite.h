...
static void mavlink_test_sys_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_sys_status_t packet_in = {
        963497464,963497672,963497880,17859,17963,18067,18171,18275,18379,18483,18587,18691,18795,18899,19003,19107,247,58,125
    };
    mavlink_sys_status_t packet1, packet2;
        ...
        packet1.voltage_battery_motor = packet_in.voltage_battery_motor;
        packet1.current_battery_motor = packet_in.current_battery_motor;
        ...
        packet1.battery_remaining_motor = packet_in.battery_remaining_motor;
