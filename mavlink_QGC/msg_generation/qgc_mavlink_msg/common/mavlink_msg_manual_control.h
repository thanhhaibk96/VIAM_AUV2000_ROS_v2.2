...
#define MAVLINK_MSG_ID_MANUAL_CONTROL_LEN 13
#define MAVLINK_MSG_ID_MANUAL_CONTROL_MIN_LEN 13
#define MAVLINK_MSG_ID_69_LEN 13
#define MAVLINK_MSG_ID_69_MIN_LEN 13

#define MAVLINK_MSG_ID_MANUAL_CONTROL_CRC 235
#define MAVLINK_MSG_ID_69_CRC 235
...
#define MAVLINK_MESSAGE_INFO_MANUAL_CONTROL { \
    ...
    {  { "target", NULL, MAVLINK_TYPE_UINT8_T, 0, 10, offsetof(mavlink_manual_control_t, target) }, \
         ...
         { "lefthat", NULL, MAVLINK_TYPE_UINT8_T, 0, 11, offsetof(mavlink_manual_control_t, lefthat) }, \
         { "righthat", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_manual_control_t, righthat) }, \
 ...
 * @param r  R-axis, normalized to the range [0,1000]. A value of INT16_MAX indicates that this axis is invalid.
 * @param lefthat  lefthat, value is 0 or 1.
 * @param righthat  righthat, Value is 0 or 1
...
static inline uint16_t mavlink_msg_manual_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target, int16_t x, int16_t y, int16_t z, int16_t r, uint8_t lefthat, uint8_t righthat, uint16_t buttons)
{
    ...
    _mav_put_uint8_t(buf, 11, lefthat);
    _mav_put_uint8_t(buf, 12, righthat);
    ...
    packet.lefthat = lefthat;
    packet.righthat = righthat;
...
{
    return mavlink_msg_manual_control_pack(system_id, component_id, msg, manual_control->target, manual_control->x, manual_control->y, manual_control->z, manual_control->r, manual_control->lefthat, manual_control->righthat, manual_control->buttons);
}
...
{
    return mavlink_msg_manual_control_pack_chan(system_id, component_id, chan, msg, manual_control->target, manual_control->x, manual_control->y, manual_control->z, manual_control->r, manual_control->lefthat, manual_control->righthat, manual_control->buttons);
}
...
static inline void mavlink_msg_manual_control_send(mavlink_channel_t chan, uint8_t target, int16_t x, int16_t y, int16_t z, int16_t r, uint8_t lefthat, uint8_t righthat, uint16_t buttons)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MANUAL_CONTROL_LEN];
    _mav_put_int16_t(buf, 0, x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_manual_control_send(chan, manual_control->target, manual_control->x, manual_control->y, manual_control->z, manual_control->r, manual_control->lefthat, manual_control->righthat, manual_control->buttons);
#else
 ...
 */
static inline void mavlink_msg_manual_control_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target, int16_t x, int16_t y, int16_t z, int16_t r, uint8_t lefthat, uint8_t righthat, uint16_t buttons)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return  R-axis, normalized to the range [0,1000]. A value of INT16_MAX indicates that this axis is invalid.
 */
...
/**
 * @brief Get field lefthat from manual_control message
 *
 * @return  lefthat, value is 0 or 1.
 */
static inline uint8_t mavlink_msg_manual_control_get_lefthat(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  11);
}

/**
 * @brief Get field righthat from manual_control message
 *
 * @return  righthat, Value is 0 or 1
 */
static inline uint8_t mavlink_msg_manual_control_get_righthat(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_manual_control_decode(const mavlink_message_t* msg, mavlink_manual_control_t* manual_control)
{
    ...
    manual_control->lefthat = mavlink_msg_manual_control_get_lefthat(msg);
    manual_control->righthat = mavlink_msg_manual_control_get_righthat(msg);
#else
