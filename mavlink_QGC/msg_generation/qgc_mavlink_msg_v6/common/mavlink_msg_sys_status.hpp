...
struct SYS_STATUS : mavlink::Message {
    ...
    inline std::string to_yaml(void) const override
    {
        ...
        ss << "  batery_total: " << batery_total << std::endl;
        ss << "  batery_capacity: " << batery_capacity << std::endl;
        ss << "  batery_used: " << batery_used << std::endl;
    ...
    inline void serialize(mavlink::MsgMap &map) const override
    {
        ...
        map << batery_total;                  // offset: 18
        map << batery_capacity;               // offset: 20
        map << batery_used;                   // offset: 22
        map << drop_rate_comm;                // offset: 24
        map << errors_comm;                   // offset: 26
        map << errors_count1;                 // offset: 28
        map << errors_count2;                 // offset: 30
        map << errors_count3;                 // offset: 32
        map << errors_count4;                 // offset: 34
        map << battery_remaining;             // offset: 36
    }
