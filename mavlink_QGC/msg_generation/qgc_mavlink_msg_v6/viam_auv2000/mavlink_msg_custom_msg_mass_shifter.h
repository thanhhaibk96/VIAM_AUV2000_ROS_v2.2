...
#define MAVLINK_MSG_ID_CUSTOM_MSG_MASS_SHIFTER_LEN 32
#define MAVLINK_MSG_ID_CUSTOM_MSG_MASS_SHIFTER_MIN_LEN 32
#define MAVLINK_MSG_ID_397_LEN 32
#define MAVLINK_MSG_ID_397_MIN_LEN 32

#define MAVLINK_MSG_ID_CUSTOM_MSG_MASS_SHIFTER_CRC 218
#define MAVLINK_MSG_ID_397_CRC 218
...
#define MAVLINK_MESSAGE_INFO_CUSTOM_MSG_MASS_SHIFTER { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_custom_msg_mass_shifter_t, time_boot_ms) }, \
         ...
         { "motor_temp_on_chip", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_custom_msg_mass_shifter_t, motor_temp_on_chip) }, \
         { "motor_temp_ambient", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_custom_msg_mass_shifter_t, motor_temp_ambient) }, \
         { "motor_current", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_custom_msg_mass_shifter_t, motor_current) }, \
         { "motor_rspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 24, offsetof(mavlink_custom_msg_mass_shifter_t, motor_rspeed) }, \
         { "motor_dspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 28, offsetof(mavlink_custom_msg_mass_shifter_t, motor_dspeed) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CUSTOM_MSG_MASS_SHIFTER { \
 ...
 * @param motor_temp_on_chip  The temperature of mass shifter's motor
 * @param motor_temp_ambient  The temperature of mass shifter's motor
...
{
    return mavlink_msg_custom_msg_mass_shifter_pack(system_id, component_id, msg, custom_msg_mass_shifter->time_boot_ms, custom_msg_mass_shifter->position, custom_msg_mass_shifter->motor_duty, custom_msg_mass_shifter->motor_temp_on_chip, custom_msg_mass_shifter->motor_temp_ambient, custom_msg_mass_shifter->motor_current, custom_msg_mass_shifter->motor_rspeed, custom_msg_mass_shifter->motor_dspeed);
}
...
static inline void mavlink_msg_custom_msg_mass_shifter_send(mavlink_channel_t chan, uint32_t time_boot_ms, float position, float motor_duty, float motor_temp_on_chip, float motor_temp_ambient, float motor_current, float motor_rspeed, float motor_dspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CUSTOM_MSG_MASS_SHIFTER_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_custom_msg_mass_shifter_send(chan, custom_msg_mass_shifter->time_boot_ms, custom_msg_mass_shifter->position, custom_msg_mass_shifter->motor_duty, custom_msg_mass_shifter->motor_temp_on_chip, custom_msg_mass_shifter->motor_temp_ambient, custom_msg_mass_shifter->motor_current, custom_msg_mass_shifter->motor_rspeed, custom_msg_mass_shifter->motor_dspeed);
#else
 ...
 */
static inline void mavlink_msg_custom_msg_mass_shifter_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float position, float motor_duty, float motor_temp_on_chip, float motor_temp_ambient, float motor_current, float motor_rspeed, float motor_dspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field motor_temp_on_chip from custom_msg_mass_shifter message
 *
 * @return  The temperature of mass shifter's motor
 */
static inline float mavlink_msg_custom_msg_mass_shifter_get_motor_temp_on_chip(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  12);
}

/**
 * @brief Get field motor_temp_ambient from custom_msg_mass_shifter message
 *
 * @return  The temperature of mass shifter's motor
 */
static inline float mavlink_msg_custom_msg_mass_shifter_get_motor_temp_ambient(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_custom_msg_mass_shifter_decode(const mavlink_message_t* msg, mavlink_custom_msg_mass_shifter_t* custom_msg_mass_shifter)
{
    ...
    custom_msg_mass_shifter->motor_temp_on_chip = mavlink_msg_custom_msg_mass_shifter_get_motor_temp_on_chip(msg);
    custom_msg_mass_shifter->motor_temp_ambient = mavlink_msg_custom_msg_mass_shifter_get_motor_temp_ambient(msg);
