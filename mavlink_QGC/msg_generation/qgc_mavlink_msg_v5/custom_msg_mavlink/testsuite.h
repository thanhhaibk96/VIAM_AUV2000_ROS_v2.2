...
static void mavlink_test_custom_msg_board_arm1(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_custom_msg_board_arm1_t packet1, packet2;
        ...
        packet1.ls_pistol_athead = packet_in.ls_pistol_athead;
        packet1.ls_pistol_attail = packet_in.ls_pistol_attail;
    ...
    mavlink_msg_custom_msg_board_arm1_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_msg_board_arm1_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.ls_pistol_athead , packet1.ls_pistol_attail , packet1.ls_mass_shifter_athead , packet1.ls_mass_shifter_attail , packet1.altimeter_in_metres , packet1.altimeter_in_feet , packet1.altimeter_in_fathoms );
    mavlink_msg_custom_msg_board_arm1_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_msg_board_arm1_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.ls_pistol_athead , packet1.ls_pistol_attail , packet1.ls_mass_shifter_athead , packet1.ls_mass_shifter_attail , packet1.altimeter_in_metres , packet1.altimeter_in_feet , packet1.altimeter_in_fathoms );
    mavlink_msg_custom_msg_board_arm1_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_custom_msg_board_arm1_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_msg_board_arm1_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.ls_pistol_athead , packet1.ls_pistol_attail , packet1.ls_mass_shifter_athead , packet1.ls_mass_shifter_attail , packet1.altimeter_in_metres , packet1.altimeter_in_feet , packet1.altimeter_in_fathoms );
    mavlink_msg_custom_msg_board_arm1_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_custom_msg_board_arm2(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_custom_msg_board_arm2_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_msg_board_arm2_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.rudder_position , packet1.rudder_speed , packet1.rudder_load , packet1.rudder_voltage , packet1.rudder_temperature , packet1.keller_pa3_pressure , packet1.keller_pa3_temperature );
    mavlink_msg_custom_msg_board_arm2_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_msg_board_arm2_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.rudder_position , packet1.rudder_speed , packet1.rudder_load , packet1.rudder_voltage , packet1.rudder_temperature , packet1.keller_pa3_pressure , packet1.keller_pa3_temperature );
    mavlink_msg_custom_msg_board_arm2_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_custom_msg_board_arm2_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_msg_board_arm2_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.rudder_position , packet1.rudder_speed , packet1.rudder_load , packet1.rudder_voltage , packet1.rudder_temperature , packet1.keller_pa3_pressure , packet1.keller_pa3_temperature );
    mavlink_msg_custom_msg_board_arm2_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
