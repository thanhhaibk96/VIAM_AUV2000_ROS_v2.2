...
TEST(custom_msg_mavlink, CUSTOM_MSG_BOARD_STATUS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::custom_msg_mavlink::msg::CUSTOM_MSG_BOARD_STATUS packet_in{};
    packet_in.time_boot_ms = 963497464;
    packet_in.arm1 = 17;
    packet_in.arm2 = 84;
    packet_in.viam_navy = 151;
    packet_in.pistol = 218;
    packet_in.mass_shifter = 29;
    packet_in.thruster = 96;

    mavlink::custom_msg_mavlink::msg::CUSTOM_MSG_BOARD_STATUS packet1{};
    mavlink::custom_msg_mavlink::msg::CUSTOM_MSG_BOARD_STATUS packet2{};
    ...
    EXPECT_EQ(packet1.time_boot_ms, packet2.time_boot_ms);
    EXPECT_EQ(packet1.arm1, packet2.arm1);
    EXPECT_EQ(packet1.arm2, packet2.arm2);
    EXPECT_EQ(packet1.viam_navy, packet2.viam_navy);
    EXPECT_EQ(packet1.pistol, packet2.pistol);
    EXPECT_EQ(packet1.mass_shifter, packet2.mass_shifter);
    EXPECT_EQ(packet1.thruster, packet2.thruster);
}

#ifdef TEST_INTEROP
TEST(custom_msg_mavlink_interop, CUSTOM_MSG_BOARD_STATUS)
{
    mavlink_message_t msg;
    ...
    mavlink_custom_msg_board_status_t packet_c {
    ...
    mavlink_msg_custom_msg_board_status_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.time_boot_ms, packet2.time_boot_ms);
    EXPECT_EQ(packet_in.arm1, packet2.arm1);
    EXPECT_EQ(packet_in.arm2, packet2.arm2);
    EXPECT_EQ(packet_in.viam_navy, packet2.viam_navy);
    EXPECT_EQ(packet_in.pistol, packet2.pistol);
    EXPECT_EQ(packet_in.mass_shifter, packet2.mass_shifter);
