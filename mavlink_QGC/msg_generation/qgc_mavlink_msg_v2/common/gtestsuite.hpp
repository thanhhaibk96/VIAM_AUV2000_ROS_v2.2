...
TEST(common, SYS_STATUS)
{
    ...
    packet_in.battery_remaining_head = -9;
    packet_in.voltage_battery_motor = 18171;
    packet_in.current_battery_motor = 18275;
    packet_in.battery_remaining_motor = 58;
    packet_in.voltage_battery_tail = 18379;
    packet_in.current_battery_tail = 18483;
    packet_in.battery_remaining_tail = 125;
    packet_in.drop_rate_comm = 18587;
    packet_in.errors_comm = 18691;
    packet_in.errors_count1 = 18795;
    packet_in.errors_count2 = 18899;
    packet_in.errors_count3 = 19003;
    packet_in.errors_count4 = 19107;
    ...
    EXPECT_EQ(packet1.voltage_battery_motor, packet2.voltage_battery_motor);
    EXPECT_EQ(packet1.current_battery_motor, packet2.current_battery_motor);
    EXPECT_EQ(packet1.battery_remaining_motor, packet2.battery_remaining_motor);
...
TEST(common_interop, SYS_STATUS)
{
    ...
    mavlink_sys_status_t packet_c {
         963497464, 963497672, 963497880, 17859, 17963, 18067, 18171, 18275, 18379, 18483, 18587, 18691, 18795, 18899, 19003, 19107, -9, 58, 125
    };
    ...
    EXPECT_EQ(packet_in.voltage_battery_motor, packet2.voltage_battery_motor);
    EXPECT_EQ(packet_in.current_battery_motor, packet2.current_battery_motor);
    EXPECT_EQ(packet_in.battery_remaining_motor, packet2.battery_remaining_motor);
...
TEST(common, MANUAL_CONTROL)
{
    ...
    packet_in.massshifter = 17235;
    packet_in.pistol = 17339;
    packet_in.rudder = 17443;
    packet_in.thruster = 17547;
    ...
    EXPECT_EQ(packet1.massshifter, packet2.massshifter);
    EXPECT_EQ(packet1.pistol, packet2.pistol);
    EXPECT_EQ(packet1.rudder, packet2.rudder);
    EXPECT_EQ(packet1.thruster, packet2.thruster);
...
TEST(common_interop, MANUAL_CONTROL)
{
    ...
    EXPECT_EQ(packet_in.massshifter, packet2.massshifter);
    EXPECT_EQ(packet_in.pistol, packet2.pistol);
    EXPECT_EQ(packet_in.rudder, packet2.rudder);
    EXPECT_EQ(packet_in.thruster, packet2.thruster);
