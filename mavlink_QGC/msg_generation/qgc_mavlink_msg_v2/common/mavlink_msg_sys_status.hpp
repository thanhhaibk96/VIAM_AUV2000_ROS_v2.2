...
struct SYS_STATUS : mavlink::Message {
    ...
    inline std::string to_yaml(void) const override
    {
        ...
        ss << "  voltage_battery_motor: " << voltage_battery_motor << std::endl;
        ss << "  current_battery_motor: " << current_battery_motor << std::endl;
        ss << "  battery_remaining_motor: " << +battery_remaining_motor << std::endl;
    ...
    inline void serialize(mavlink::MsgMap &map) const override
    {
        ...
        map << voltage_battery_motor;         // offset: 18
        map << current_battery_motor;         // offset: 20
        map << voltage_battery_tail;          // offset: 22
        map << current_battery_tail;          // offset: 24
        map << drop_rate_comm;                // offset: 26
        map << errors_comm;                   // offset: 28
        map << errors_count1;                 // offset: 30
        map << errors_count2;                 // offset: 32
        map << errors_count3;                 // offset: 34
        map << errors_count4;                 // offset: 36
        map << battery_remaining_head;        // offset: 38
        map << battery_remaining_motor;       // offset: 39
        map << battery_remaining_tail;        // offset: 40
    }
