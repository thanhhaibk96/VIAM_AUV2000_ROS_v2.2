...
typedef struct __mavlink_sys_status_t {
 ...
 uint16_t voltage_battery_head; /*< [mV] Battery voltage of head*/
 int16_t current_battery_head; /*< [cA] Battery current of head, -1: autopilot does not measure the current*/
 uint16_t voltage_battery_motor; /*< [mV] Battery voltage of motor*/
 int16_t current_battery_motor; /*< [cA] Battery current of motor, -1: autopilot does not measure the current*/
 uint16_t voltage_battery_tail; /*< [mV] Battery voltage of tail*/
 int16_t current_battery_tail; /*< [cA] Battery current of tail, -1: autopilot does not measure the current*/
 ...
 int8_t battery_remaining_head; /*< [%] Remaining battery energy of head, -1: autopilot estimate the remaining battery*/
 int8_t battery_remaining_motor; /*< [%] Remaining battery energy of motor, -1: autopilot estimate the remaining battery*/
 int8_t battery_remaining_tail; /*< [%] Remaining battery energy of tail, -1: autopilot estimate the remaining battery*/
 ...
 * @param voltage_battery_head [mV] Battery voltage of head
 * @param current_battery_head [cA] Battery current of head, -1: autopilot does not measure the current
 * @param battery_remaining_head [%] Remaining battery energy of head, -1: autopilot estimate the remaining battery
 * @param voltage_battery_motor [mV] Battery voltage of motor
 * @param current_battery_motor [cA] Battery current of motor, -1: autopilot does not measure the current
 * @param battery_remaining_motor [%] Remaining battery energy of motor, -1: autopilot estimate the remaining battery
 * @param voltage_battery_tail [mV] Battery voltage of tail
 * @param current_battery_tail [cA] Battery current of tail, -1: autopilot does not measure the current
 * @param battery_remaining_tail [%] Remaining battery energy of tail, -1: autopilot estimate the remaining battery
 ...
 *
 * @return [mV] Battery voltage of head
 */
 ...
 *
 * @return [cA] Battery current of head, -1: autopilot does not measure the current
 */
 ...
 *
 * @return [%] Remaining battery energy of head, -1: autopilot estimate the remaining battery
 */
 ...
 *
 * @return [mV] Battery voltage of motor
 */
 ...
 *
 * @return [cA] Battery current of motor, -1: autopilot does not measure the current
 */
 ...
 *
 * @return [%] Remaining battery energy of motor, -1: autopilot estimate the remaining battery
 */
 ...
 *
 * @return [mV] Battery voltage of tail
 */
 ...
 *
 * @return [cA] Battery current of tail, -1: autopilot does not measure the current
 */
 ...
 *
 * @return [%] Remaining battery energy of tail, -1: autopilot estimate the remaining battery
 */
