...
TEST(common, SYS_STATUS)
{
    ...
    packet_in.voltage_battery_head = 17963;
    packet_in.current_battery_head = 18067;
    packet_in.battery_remaining_head = 15;
    packet_in.batery_total_head = 18171;
    packet_in.batery_capacity_head = 18275;
    packet_in.batery_used_head = 18379;
    packet_in.voltage_battery_tail = 18483;
    packet_in.current_battery_tail = 18587;
    packet_in.battery_remaining_tail = 82;
    packet_in.batery_total_tail = 18691;
    packet_in.batery_capacity_tail = 18795;
    packet_in.batery_used_tail = 18899;
    packet_in.drop_rate_comm = 19003;
    packet_in.errors_comm = 19107;
    packet_in.errors_count1 = 19211;
    packet_in.errors_count2 = 19315;
    packet_in.errors_count3 = 19419;
    packet_in.errors_count4 = 19523;
    ...
    EXPECT_EQ(packet1.voltage_battery_head, packet2.voltage_battery_head);
    EXPECT_EQ(packet1.current_battery_head, packet2.current_battery_head);
    EXPECT_EQ(packet1.battery_remaining_head, packet2.battery_remaining_head);
    EXPECT_EQ(packet1.batery_total_head, packet2.batery_total_head);
    EXPECT_EQ(packet1.batery_capacity_head, packet2.batery_capacity_head);
    EXPECT_EQ(packet1.batery_used_head, packet2.batery_used_head);
    EXPECT_EQ(packet1.voltage_battery_tail, packet2.voltage_battery_tail);
    EXPECT_EQ(packet1.current_battery_tail, packet2.current_battery_tail);
    EXPECT_EQ(packet1.battery_remaining_tail, packet2.battery_remaining_tail);
    EXPECT_EQ(packet1.batery_total_tail, packet2.batery_total_tail);
    EXPECT_EQ(packet1.batery_capacity_tail, packet2.batery_capacity_tail);
    EXPECT_EQ(packet1.batery_used_tail, packet2.batery_used_tail);
...
TEST(common_interop, SYS_STATUS)
{
    ...
    mavlink_sys_status_t packet_c {
         963497464, 963497672, 963497880, 17859, 17963, 18067, 18171, 18275, 18379, 18483, 18587, 18691, 18795, 18899, 19003, 19107, 19211, 19315, 19419, 19523, 15, 82
    };
    ...
    EXPECT_EQ(packet_in.voltage_battery_head, packet2.voltage_battery_head);
    EXPECT_EQ(packet_in.current_battery_head, packet2.current_battery_head);
    EXPECT_EQ(packet_in.battery_remaining_head, packet2.battery_remaining_head);
    EXPECT_EQ(packet_in.batery_total_head, packet2.batery_total_head);
    EXPECT_EQ(packet_in.batery_capacity_head, packet2.batery_capacity_head);
    EXPECT_EQ(packet_in.batery_used_head, packet2.batery_used_head);
    EXPECT_EQ(packet_in.voltage_battery_tail, packet2.voltage_battery_tail);
    EXPECT_EQ(packet_in.current_battery_tail, packet2.current_battery_tail);
    EXPECT_EQ(packet_in.battery_remaining_tail, packet2.battery_remaining_tail);
    EXPECT_EQ(packet_in.batery_total_tail, packet2.batery_total_tail);
    EXPECT_EQ(packet_in.batery_capacity_tail, packet2.batery_capacity_tail);
    EXPECT_EQ(packet_in.batery_used_tail, packet2.batery_used_tail);
...
TEST(common, MANUAL_CONTROL)
{
    ...
    packet_in.z = 17443;
    packet_in.r = 17547;
    packet_in.lefthat = 230;
    packet_in.righthat = 41;
    ...
    EXPECT_EQ(packet1.lefthat, packet2.lefthat);
    EXPECT_EQ(packet1.righthat, packet2.righthat);
...
TEST(common_interop, MANUAL_CONTROL)
{
    ...
    mavlink_manual_control_t packet_c {
         17235, 17339, 17443, 17547, 17651, 163, 230, 41
    };
    ...
    EXPECT_EQ(packet_in.lefthat, packet2.lefthat);
    EXPECT_EQ(packet_in.righthat, packet2.righthat);
