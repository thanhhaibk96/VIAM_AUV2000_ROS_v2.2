...
#define MAVLINK_MSG_ID_SYS_STATUS_LEN 48
#define MAVLINK_MSG_ID_SYS_STATUS_MIN_LEN 48
#define MAVLINK_MSG_ID_1_LEN 48
#define MAVLINK_MSG_ID_1_MIN_LEN 48

#define MAVLINK_MSG_ID_SYS_STATUS_CRC 173
#define MAVLINK_MSG_ID_1_CRC 173
...
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
    ...
    {  { "onboard_control_sensors_present", "0x%04x", MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_sys_status_t, onboard_control_sensors_present) }, \
         ...
         { "battery_remaining_head", NULL, MAVLINK_TYPE_INT8_T, 0, 46, offsetof(mavlink_sys_status_t, battery_remaining_head) }, \
         { "batery_total_head", NULL, MAVLINK_TYPE_UINT16_T, 0, 18, offsetof(mavlink_sys_status_t, batery_total_head) }, \
         { "batery_capacity_head", NULL, MAVLINK_TYPE_UINT16_T, 0, 20, offsetof(mavlink_sys_status_t, batery_capacity_head) }, \
         { "batery_used_head", NULL, MAVLINK_TYPE_UINT16_T, 0, 22, offsetof(mavlink_sys_status_t, batery_used_head) }, \
         { "voltage_battery_tail", NULL, MAVLINK_TYPE_UINT16_T, 0, 24, offsetof(mavlink_sys_status_t, voltage_battery_tail) }, \
         { "current_battery_tail", NULL, MAVLINK_TYPE_INT16_T, 0, 26, offsetof(mavlink_sys_status_t, current_battery_tail) }, \
         { "battery_remaining_tail", NULL, MAVLINK_TYPE_INT8_T, 0, 47, offsetof(mavlink_sys_status_t, battery_remaining_tail) }, \
         { "batery_total_tail", NULL, MAVLINK_TYPE_UINT16_T, 0, 28, offsetof(mavlink_sys_status_t, batery_total_tail) }, \
         { "batery_capacity_tail", NULL, MAVLINK_TYPE_UINT16_T, 0, 30, offsetof(mavlink_sys_status_t, batery_capacity_tail) }, \
         { "batery_used_tail", NULL, MAVLINK_TYPE_UINT16_T, 0, 32, offsetof(mavlink_sys_status_t, batery_used_tail) }, \
         { "drop_rate_comm", NULL, MAVLINK_TYPE_UINT16_T, 0, 34, offsetof(mavlink_sys_status_t, drop_rate_comm) }, \
         { "errors_comm", NULL, MAVLINK_TYPE_UINT16_T, 0, 36, offsetof(mavlink_sys_status_t, errors_comm) }, \
         { "errors_count1", NULL, MAVLINK_TYPE_UINT16_T, 0, 38, offsetof(mavlink_sys_status_t, errors_count1) }, \
         { "errors_count2", NULL, MAVLINK_TYPE_UINT16_T, 0, 40, offsetof(mavlink_sys_status_t, errors_count2) }, \
         { "errors_count3", NULL, MAVLINK_TYPE_UINT16_T, 0, 42, offsetof(mavlink_sys_status_t, errors_count3) }, \
         { "errors_count4", NULL, MAVLINK_TYPE_UINT16_T, 0, 44, offsetof(mavlink_sys_status_t, errors_count4) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
 ...
 * @param batery_total_head [mAh] Total Capacity of Battery at head, -1: autopilot does not measure the current
 * @param batery_capacity_head [mAh] Current Capacity of Battery at head, -1: autopilot does not measure the current
 * @param batery_used_head [mAh] Used Capacity of Battery at head, -1: autopilot does not measure the current
 ...
 * @param batery_total_tail [mAh] Total Capacity of Battery at tail, -1: autopilot does not measure the current
 * @param batery_capacity_tail [mAh] Current Capacity of Battery at tail, -1: autopilot does not measure the current
 * @param batery_used_tail [mAh] Used Capacity of Battery at tail, -1: autopilot does not measure the current
...
static inline uint16_t mavlink_msg_sys_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t onboard_control_sensors_present, uint32_t onboard_control_sensors_enabled, uint32_t onboard_control_sensors_health, uint16_t load, uint16_t voltage_battery_head, int16_t current_battery_head, int8_t battery_remaining_head, uint16_t batery_total_head, uint16_t batery_capacity_head, uint16_t batery_used_head, uint16_t voltage_battery_tail, int16_t current_battery_tail, int8_t battery_remaining_tail, uint16_t batery_total_tail, uint16_t batery_capacity_tail, uint16_t batery_used_tail, uint16_t drop_rate_comm, uint16_t errors_comm, uint16_t errors_count1, uint16_t errors_count2, uint16_t errors_count3, uint16_t errors_count4)
{
    ...
    _mav_put_uint16_t(buf, 18, batery_total_head);
    _mav_put_uint16_t(buf, 20, batery_capacity_head);
    _mav_put_uint16_t(buf, 22, batery_used_head);
    _mav_put_uint16_t(buf, 24, voltage_battery_tail);
    _mav_put_int16_t(buf, 26, current_battery_tail);
    _mav_put_uint16_t(buf, 28, batery_total_tail);
    _mav_put_uint16_t(buf, 30, batery_capacity_tail);
    _mav_put_uint16_t(buf, 32, batery_used_tail);
    _mav_put_uint16_t(buf, 34, drop_rate_comm);
    _mav_put_uint16_t(buf, 36, errors_comm);
    _mav_put_uint16_t(buf, 38, errors_count1);
    _mav_put_uint16_t(buf, 40, errors_count2);
    _mav_put_uint16_t(buf, 42, errors_count3);
    _mav_put_uint16_t(buf, 44, errors_count4);
    _mav_put_int8_t(buf, 46, battery_remaining_head);
    _mav_put_int8_t(buf, 47, battery_remaining_tail);
    ...
    packet.batery_total_head = batery_total_head;
    packet.batery_capacity_head = batery_capacity_head;
    packet.batery_used_head = batery_used_head;
    packet.voltage_battery_tail = voltage_battery_tail;
    packet.current_battery_tail = current_battery_tail;
    packet.batery_total_tail = batery_total_tail;
    packet.batery_capacity_tail = batery_capacity_tail;
    packet.batery_used_tail = batery_used_tail;
...
{
    return mavlink_msg_sys_status_pack(system_id, component_id, msg, sys_status->onboard_control_sensors_present, sys_status->onboard_control_sensors_enabled, sys_status->onboard_control_sensors_health, sys_status->load, sys_status->voltage_battery_head, sys_status->current_battery_head, sys_status->battery_remaining_head, sys_status->batery_total_head, sys_status->batery_capacity_head, sys_status->batery_used_head, sys_status->voltage_battery_tail, sys_status->current_battery_tail, sys_status->battery_remaining_tail, sys_status->batery_total_tail, sys_status->batery_capacity_tail, sys_status->batery_used_tail, sys_status->drop_rate_comm, sys_status->errors_comm, sys_status->errors_count1, sys_status->errors_count2, sys_status->errors_count3, sys_status->errors_count4);
}
...
/**
 * @brief Get field batery_total_head from sys_status message
 *
 * @return [mAh] Total Capacity of Battery at head, -1: autopilot does not measure the current
 */
static inline uint16_t mavlink_msg_sys_status_get_batery_total_head(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  18);
}

/**
 * @brief Get field batery_capacity_head from sys_status message
 *
 * @return [mAh] Current Capacity of Battery at head, -1: autopilot does not measure the current
 */
static inline uint16_t mavlink_msg_sys_status_get_batery_capacity_head(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  20);
}

/**
 * @brief Get field batery_used_head from sys_status message
 *
 * @return [mAh] Used Capacity of Battery at head, -1: autopilot does not measure the current
 */
static inline uint16_t mavlink_msg_sys_status_get_batery_used_head(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field batery_total_tail from sys_status message
 *
 * @return [mAh] Total Capacity of Battery at tail, -1: autopilot does not measure the current
 */
static inline uint16_t mavlink_msg_sys_status_get_batery_total_tail(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  28);
}

/**
 * @brief Get field batery_capacity_tail from sys_status message
 *
 * @return [mAh] Current Capacity of Battery at tail, -1: autopilot does not measure the current
 */
static inline uint16_t mavlink_msg_sys_status_get_batery_capacity_tail(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  30);
}

/**
 * @brief Get field batery_used_tail from sys_status message
 *
 * @return [mAh] Used Capacity of Battery at tail, -1: autopilot does not measure the current
 */
static inline uint16_t mavlink_msg_sys_status_get_batery_used_tail(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_sys_status_decode(const mavlink_message_t* msg, mavlink_sys_status_t* sys_status)
{
    ...
    sys_status->batery_total_head = mavlink_msg_sys_status_get_batery_total_head(msg);
    sys_status->batery_capacity_head = mavlink_msg_sys_status_get_batery_capacity_head(msg);
    sys_status->batery_used_head = mavlink_msg_sys_status_get_batery_used_head(msg);
    ...
    sys_status->batery_total_tail = mavlink_msg_sys_status_get_batery_total_tail(msg);
    sys_status->batery_capacity_tail = mavlink_msg_sys_status_get_batery_capacity_tail(msg);
    sys_status->batery_used_tail = mavlink_msg_sys_status_get_batery_used_tail(msg);
