...
static void mavlink_test_sys_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_sys_status_t packet1, packet2;
        ...
        packet1.voltage_battery_head = packet_in.voltage_battery_head;
        packet1.current_battery_head = packet_in.current_battery_head;
        packet1.batery_total_head = packet_in.batery_total_head;
        packet1.batery_capacity_head = packet_in.batery_capacity_head;
        packet1.batery_used_head = packet_in.batery_used_head;
        packet1.voltage_battery_tail = packet_in.voltage_battery_tail;
        packet1.current_battery_tail = packet_in.current_battery_tail;
        packet1.batery_total_tail = packet_in.batery_total_tail;
        packet1.batery_capacity_tail = packet_in.batery_capacity_tail;
        packet1.batery_used_tail = packet_in.batery_used_tail;
        ...
        packet1.battery_remaining_head = packet_in.battery_remaining_head;
        packet1.battery_remaining_tail = packet_in.battery_remaining_tail;
    ...
    mavlink_msg_sys_status_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sys_status_pack(system_id, component_id, &msg , packet1.onboard_control_sensors_present , packet1.onboard_control_sensors_enabled , packet1.onboard_control_sensors_health , packet1.load , packet1.voltage_battery_head , packet1.current_battery_head , packet1.battery_remaining_head , packet1.batery_total_head , packet1.batery_capacity_head , packet1.batery_used_head , packet1.voltage_battery_tail , packet1.current_battery_tail , packet1.battery_remaining_tail , packet1.batery_total_tail , packet1.batery_capacity_tail , packet1.batery_used_tail , packet1.drop_rate_comm , packet1.errors_comm , packet1.errors_count1 , packet1.errors_count2 , packet1.errors_count3 , packet1.errors_count4 );
    mavlink_msg_sys_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sys_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.onboard_control_sensors_present , packet1.onboard_control_sensors_enabled , packet1.onboard_control_sensors_health , packet1.load , packet1.voltage_battery_head , packet1.current_battery_head , packet1.battery_remaining_head , packet1.batery_total_head , packet1.batery_capacity_head , packet1.batery_used_head , packet1.voltage_battery_tail , packet1.current_battery_tail , packet1.battery_remaining_tail , packet1.batery_total_tail , packet1.batery_capacity_tail , packet1.batery_used_tail , packet1.drop_rate_comm , packet1.errors_comm , packet1.errors_count1 , packet1.errors_count2 , packet1.errors_count3 , packet1.errors_count4 );
    mavlink_msg_sys_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sys_status_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sys_status_send(MAVLINK_COMM_1 , packet1.onboard_control_sensors_present , packet1.onboard_control_sensors_enabled , packet1.onboard_control_sensors_health , packet1.load , packet1.voltage_battery_head , packet1.current_battery_head , packet1.battery_remaining_head , packet1.batery_total_head , packet1.batery_capacity_head , packet1.batery_used_head , packet1.voltage_battery_tail , packet1.current_battery_tail , packet1.battery_remaining_tail , packet1.batery_total_tail , packet1.batery_capacity_tail , packet1.batery_used_tail , packet1.drop_rate_comm , packet1.errors_comm , packet1.errors_count1 , packet1.errors_count2 , packet1.errors_count3 , packet1.errors_count4 );
    mavlink_msg_sys_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_manual_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_manual_control_t packet1, packet2;
        ...
        packet1.lefthat = packet_in.lefthat;
        packet1.righthat = packet_in.righthat;
    ...
    mavlink_msg_manual_control_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_manual_control_pack(system_id, component_id, &msg , packet1.target , packet1.x , packet1.y , packet1.z , packet1.r , packet1.lefthat , packet1.righthat , packet1.buttons );
    mavlink_msg_manual_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_manual_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target , packet1.x , packet1.y , packet1.z , packet1.r , packet1.lefthat , packet1.righthat , packet1.buttons );
    mavlink_msg_manual_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_manual_control_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_manual_control_send(MAVLINK_COMM_1 , packet1.target , packet1.x , packet1.y , packet1.z , packet1.r , packet1.lefthat , packet1.righthat , packet1.buttons );
    mavlink_msg_manual_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
