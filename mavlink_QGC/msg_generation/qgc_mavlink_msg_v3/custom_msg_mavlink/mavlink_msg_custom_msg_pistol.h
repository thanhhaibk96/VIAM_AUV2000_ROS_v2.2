...
#define MAVLINK_MSG_ID_CUSTOM_MSG_PISTOL_LEN 28
#define MAVLINK_MSG_ID_CUSTOM_MSG_PISTOL_MIN_LEN 28
#define MAVLINK_MSG_ID_396_LEN 28
#define MAVLINK_MSG_ID_396_MIN_LEN 28

#define MAVLINK_MSG_ID_CUSTOM_MSG_PISTOL_CRC 185
#define MAVLINK_MSG_ID_396_CRC 185
...
#define MAVLINK_MESSAGE_INFO_CUSTOM_MSG_PISTOL { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_custom_msg_pistol_t, time_boot_ms) }, \
         ...
         { "motor_temp", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_custom_msg_pistol_t, motor_temp) }, \
         { "motor_current", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_custom_msg_pistol_t, motor_current) }, \
         { "motor_rspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_custom_msg_pistol_t, motor_rspeed) }, \
         { "motor_dspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 24, offsetof(mavlink_custom_msg_pistol_t, motor_dspeed) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CUSTOM_MSG_PISTOL { \
 ...
 * @param motor_temp  The temperature of Pistol's motor
...
{
    return mavlink_msg_custom_msg_pistol_pack(system_id, component_id, msg, custom_msg_pistol->time_boot_ms, custom_msg_pistol->position, custom_msg_pistol->motor_duty, custom_msg_pistol->motor_temp, custom_msg_pistol->motor_current, custom_msg_pistol->motor_rspeed, custom_msg_pistol->motor_dspeed);
}
...
{
    return mavlink_msg_custom_msg_pistol_pack_chan(system_id, component_id, chan, msg, custom_msg_pistol->time_boot_ms, custom_msg_pistol->position, custom_msg_pistol->motor_duty, custom_msg_pistol->motor_temp, custom_msg_pistol->motor_current, custom_msg_pistol->motor_rspeed, custom_msg_pistol->motor_dspeed);
}
...
static inline void mavlink_msg_custom_msg_pistol_send(mavlink_channel_t chan, uint32_t time_boot_ms, float position, float motor_duty, float motor_temp, float motor_current, float motor_rspeed, float motor_dspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CUSTOM_MSG_PISTOL_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_custom_msg_pistol_send(chan, custom_msg_pistol->time_boot_ms, custom_msg_pistol->position, custom_msg_pistol->motor_duty, custom_msg_pistol->motor_temp, custom_msg_pistol->motor_current, custom_msg_pistol->motor_rspeed, custom_msg_pistol->motor_dspeed);
#else
 ...
 */
static inline void mavlink_msg_custom_msg_pistol_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float position, float motor_duty, float motor_temp, float motor_current, float motor_rspeed, float motor_dspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field motor_temp from custom_msg_pistol message
 *
 * @return  The temperature of Pistol's motor
 */
static inline float mavlink_msg_custom_msg_pistol_get_motor_temp(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_custom_msg_pistol_decode(const mavlink_message_t* msg, mavlink_custom_msg_pistol_t* custom_msg_pistol)
{
    ...
    custom_msg_pistol->motor_temp = mavlink_msg_custom_msg_pistol_get_motor_temp(msg);
