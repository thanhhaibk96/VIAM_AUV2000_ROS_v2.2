...
TEST(common, SYS_STATUS)
{
    ...
    packet_in.battery_remaining = 113;
    packet_in.batery_total = 18171;
    packet_in.batery_capacity = 18275;
    packet_in.batery_used = 18379;
    packet_in.drop_rate_comm = 18483;
    packet_in.errors_comm = 18587;
    packet_in.errors_count1 = 18691;
    packet_in.errors_count2 = 18795;
    packet_in.errors_count3 = 18899;
    packet_in.errors_count4 = 19003;
    ...
    EXPECT_EQ(packet1.batery_total, packet2.batery_total);
    EXPECT_EQ(packet1.batery_capacity, packet2.batery_capacity);
    EXPECT_EQ(packet1.batery_used, packet2.batery_used);
...
TEST(common_interop, SYS_STATUS)
{
    ...
    mavlink_sys_status_t packet_c {
         963497464, 963497672, 963497880, 17859, 17963, 18067, 18171, 18275, 18379, 18483, 18587, 18691, 18795, 18899, 19003, 113
    };
    ...
    EXPECT_EQ(packet_in.batery_total, packet2.batery_total);
    EXPECT_EQ(packet_in.batery_capacity, packet2.batery_capacity);
    EXPECT_EQ(packet_in.batery_used, packet2.batery_used);
...
TEST(common, PARAM_EXT_ACK_TRIMMED)
{
    ...
    packet_in.param_id = to_char_array("ABCDEFGHIJKLMNO");
    packet_in.param_type = 53;
    packet_in.param_result = 120;
    packet_in.param_value = to_char_array("STUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNO");
...
TEST(common, PARAM_START_TRANSACTION)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::PARAM_START_TRANSACTION packet_in{};
    packet_in.target_system = 139;
    packet_in.target_component = 206;
    packet_in.param_transport = 17;
    packet_in.transaction_id = 17235;
    packet_in.response = 84;

    mavlink::common::msg::PARAM_START_TRANSACTION packet1{};
    mavlink::common::msg::PARAM_START_TRANSACTION packet2{};
    ...
    EXPECT_EQ(packet1.target_system, packet2.target_system);
    EXPECT_EQ(packet1.target_component, packet2.target_component);
    EXPECT_EQ(packet1.param_transport, packet2.param_transport);
    EXPECT_EQ(packet1.transaction_id, packet2.transaction_id);
    EXPECT_EQ(packet1.response, packet2.response);
}

#ifdef TEST_INTEROP
TEST(common_interop, PARAM_START_TRANSACTION)
{
    mavlink_message_t msg;
    ...
    mavlink_param_start_transaction_t packet_c {
         17235, 139, 206, 17, 84
    };
    ...
    mavlink_msg_param_start_transaction_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.target_system, packet2.target_system);
    EXPECT_EQ(packet_in.target_component, packet2.target_component);
    EXPECT_EQ(packet_in.param_transport, packet2.param_transport);
...
TEST(common, PARAM_COMMIT_TRANSACTION)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::PARAM_COMMIT_TRANSACTION packet_in{};
    packet_in.target_system = 139;
    packet_in.target_component = 206;
    packet_in.param_action = 17;
    packet_in.transaction_id = 17235;
    packet_in.response = 84;

    mavlink::common::msg::PARAM_COMMIT_TRANSACTION packet1{};
    mavlink::common::msg::PARAM_COMMIT_TRANSACTION packet2{};
    ...
    EXPECT_EQ(packet1.target_system, packet2.target_system);
    EXPECT_EQ(packet1.target_component, packet2.target_component);
    EXPECT_EQ(packet1.param_action, packet2.param_action);
    EXPECT_EQ(packet1.transaction_id, packet2.transaction_id);
    EXPECT_EQ(packet1.response, packet2.response);
}

#ifdef TEST_INTEROP
TEST(common_interop, PARAM_COMMIT_TRANSACTION)
{
    mavlink_message_t msg;
    ...
    mavlink_param_commit_transaction_t packet_c {
         17235, 139, 206, 17, 84
    };
    ...
    mavlink_msg_param_commit_transaction_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.target_system, packet2.target_system);
    EXPECT_EQ(packet_in.target_component, packet2.target_component);
    EXPECT_EQ(packet_in.param_action, packet2.param_action);
    EXPECT_EQ(packet_in.transaction_id, packet2.transaction_id);
    EXPECT_EQ(packet_in.response, packet2.response);
