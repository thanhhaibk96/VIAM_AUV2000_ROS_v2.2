...
#define MAVLINK_MSG_ID_CUSTOM_MSG_BOARD_ARM2_LEN 37
#define MAVLINK_MSG_ID_CUSTOM_MSG_BOARD_ARM2_MIN_LEN 37
#define MAVLINK_MSG_ID_402_LEN 37
#define MAVLINK_MSG_ID_402_MIN_LEN 37

#define MAVLINK_MSG_ID_CUSTOM_MSG_BOARD_ARM2_CRC 242
#define MAVLINK_MSG_ID_402_CRC 242
...
#define MAVLINK_MESSAGE_INFO_CUSTOM_MSG_BOARD_ARM2 { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_custom_msg_board_arm2_t, time_boot_ms) }, \
         { "leak_sensor", NULL, MAVLINK_TYPE_UINT8_T, 0, 36, offsetof(mavlink_custom_msg_board_arm2_t, leak_sensor) }, \
         ...
         { "roll_motor_angle", NULL, MAVLINK_TYPE_FLOAT, 0, 32, offsetof(mavlink_custom_msg_board_arm2_t, roll_motor_angle) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CUSTOM_MSG_BOARD_ARM2 { \
...
static inline uint16_t mavlink_msg_custom_msg_board_arm2_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_boot_ms, uint8_t leak_sensor, float rudder_position, float rudder_speed, float rudder_load, float rudder_voltage, float rudder_temperature, float keller_pa3_pressure, float keller_pa3_temperature, float roll_motor_angle)
{
    ...
    _mav_put_float(buf, 32, roll_motor_angle);
    _mav_put_uint8_t(buf, 36, leak_sensor);
...
{
    return mavlink_msg_custom_msg_board_arm2_pack(system_id, component_id, msg, custom_msg_board_arm2->time_boot_ms, custom_msg_board_arm2->leak_sensor, custom_msg_board_arm2->rudder_position, custom_msg_board_arm2->rudder_speed, custom_msg_board_arm2->rudder_load, custom_msg_board_arm2->rudder_voltage, custom_msg_board_arm2->rudder_temperature, custom_msg_board_arm2->keller_pa3_pressure, custom_msg_board_arm2->keller_pa3_temperature, custom_msg_board_arm2->roll_motor_angle);
}
...
{
    return mavlink_msg_custom_msg_board_arm2_pack_chan(system_id, component_id, chan, msg, custom_msg_board_arm2->time_boot_ms, custom_msg_board_arm2->leak_sensor, custom_msg_board_arm2->rudder_position, custom_msg_board_arm2->rudder_speed, custom_msg_board_arm2->rudder_load, custom_msg_board_arm2->rudder_voltage, custom_msg_board_arm2->rudder_temperature, custom_msg_board_arm2->keller_pa3_pressure, custom_msg_board_arm2->keller_pa3_temperature, custom_msg_board_arm2->roll_motor_angle);
}
...
static inline void mavlink_msg_custom_msg_board_arm2_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t leak_sensor, float rudder_position, float rudder_speed, float rudder_load, float rudder_voltage, float rudder_temperature, float keller_pa3_pressure, float keller_pa3_temperature, float roll_motor_angle)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CUSTOM_MSG_BOARD_ARM2_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_custom_msg_board_arm2_send(chan, custom_msg_board_arm2->time_boot_ms, custom_msg_board_arm2->leak_sensor, custom_msg_board_arm2->rudder_position, custom_msg_board_arm2->rudder_speed, custom_msg_board_arm2->rudder_load, custom_msg_board_arm2->rudder_voltage, custom_msg_board_arm2->rudder_temperature, custom_msg_board_arm2->keller_pa3_pressure, custom_msg_board_arm2->keller_pa3_temperature, custom_msg_board_arm2->roll_motor_angle);
#else
 ...
 */
static inline void mavlink_msg_custom_msg_board_arm2_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, uint8_t leak_sensor, float rudder_position, float rudder_speed, float rudder_load, float rudder_voltage, float rudder_temperature, float keller_pa3_pressure, float keller_pa3_temperature, float roll_motor_angle)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field leak_sensor from custom_msg_board_arm2 message
 *
 * @return  Value of Leak Sensors
 */
static inline uint8_t mavlink_msg_custom_msg_board_arm2_get_leak_sensor(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field roll_motor_angle from custom_msg_board_arm2 message
 *
 * @return  Angle of Motor for Antiing Roll
 */
static inline float mavlink_msg_custom_msg_board_arm2_get_roll_motor_angle(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_custom_msg_board_arm2_decode(const mavlink_message_t* msg, mavlink_custom_msg_board_arm2_t* custom_msg_board_arm2)
{
    ...
    custom_msg_board_arm2->roll_motor_angle = mavlink_msg_custom_msg_board_arm2_get_roll_motor_angle(msg);
    custom_msg_board_arm2->leak_sensor = mavlink_msg_custom_msg_board_arm2_get_leak_sensor(msg);
#else
