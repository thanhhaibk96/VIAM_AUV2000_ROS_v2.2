...
typedef struct __mavlink_sys_status_t {
 ...
 uint16_t batery_total; /*< [mAh] Total Capacity of Battery, -1: autopilot does not measure the current*/
 uint16_t batery_capacity; /*< [mAh] Current Capacity of Battery, -1: autopilot does not measure the current*/
 uint16_t batery_used; /*< [mAh] Used Capacity of Battery, -1: autopilot does not measure the current*/
...
#define MAVLINK_MSG_ID_SYS_STATUS_LEN 37
#define MAVLINK_MSG_ID_SYS_STATUS_MIN_LEN 37
#define MAVLINK_MSG_ID_1_LEN 37
#define MAVLINK_MSG_ID_1_MIN_LEN 37

#define MAVLINK_MSG_ID_SYS_STATUS_CRC 109
#define MAVLINK_MSG_ID_1_CRC 109
...
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
    ...
    {  { "onboard_control_sensors_present", "0x%04x", MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_sys_status_t, onboard_control_sensors_present) }, \
         ...
         { "battery_remaining", NULL, MAVLINK_TYPE_INT8_T, 0, 36, offsetof(mavlink_sys_status_t, battery_remaining) }, \
         { "batery_total", NULL, MAVLINK_TYPE_UINT16_T, 0, 18, offsetof(mavlink_sys_status_t, batery_total) }, \
         { "batery_capacity", NULL, MAVLINK_TYPE_UINT16_T, 0, 20, offsetof(mavlink_sys_status_t, batery_capacity) }, \
         { "batery_used", NULL, MAVLINK_TYPE_UINT16_T, 0, 22, offsetof(mavlink_sys_status_t, batery_used) }, \
         { "drop_rate_comm", NULL, MAVLINK_TYPE_UINT16_T, 0, 24, offsetof(mavlink_sys_status_t, drop_rate_comm) }, \
         { "errors_comm", NULL, MAVLINK_TYPE_UINT16_T, 0, 26, offsetof(mavlink_sys_status_t, errors_comm) }, \
         { "errors_count1", NULL, MAVLINK_TYPE_UINT16_T, 0, 28, offsetof(mavlink_sys_status_t, errors_count1) }, \
         { "errors_count2", NULL, MAVLINK_TYPE_UINT16_T, 0, 30, offsetof(mavlink_sys_status_t, errors_count2) }, \
         { "errors_count3", NULL, MAVLINK_TYPE_UINT16_T, 0, 32, offsetof(mavlink_sys_status_t, errors_count3) }, \
         { "errors_count4", NULL, MAVLINK_TYPE_UINT16_T, 0, 34, offsetof(mavlink_sys_status_t, errors_count4) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
 ...
 * @param batery_total [mAh] Total Capacity of Battery, -1: autopilot does not measure the current
 * @param batery_capacity [mAh] Current Capacity of Battery, -1: autopilot does not measure the current
 * @param batery_used [mAh] Used Capacity of Battery, -1: autopilot does not measure the current
...
static inline uint16_t mavlink_msg_sys_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t onboard_control_sensors_present, uint32_t onboard_control_sensors_enabled, uint32_t onboard_control_sensors_health, uint16_t load, uint16_t voltage_battery, int16_t current_battery, int8_t battery_remaining, uint16_t batery_total, uint16_t batery_capacity, uint16_t batery_used, uint16_t drop_rate_comm, uint16_t errors_comm, uint16_t errors_count1, uint16_t errors_count2, uint16_t errors_count3, uint16_t errors_count4)
{
    ...
    _mav_put_uint16_t(buf, 18, batery_total);
    _mav_put_uint16_t(buf, 20, batery_capacity);
    _mav_put_uint16_t(buf, 22, batery_used);
    _mav_put_uint16_t(buf, 24, drop_rate_comm);
    _mav_put_uint16_t(buf, 26, errors_comm);
    _mav_put_uint16_t(buf, 28, errors_count1);
    _mav_put_uint16_t(buf, 30, errors_count2);
    _mav_put_uint16_t(buf, 32, errors_count3);
    _mav_put_uint16_t(buf, 34, errors_count4);
    ...
    packet.batery_total = batery_total;
    packet.batery_capacity = batery_capacity;
    packet.batery_used = batery_used;
...
{
    return mavlink_msg_sys_status_pack(system_id, component_id, msg, sys_status->onboard_control_sensors_present, sys_status->onboard_control_sensors_enabled, sys_status->onboard_control_sensors_health, sys_status->load, sys_status->voltage_battery, sys_status->current_battery, sys_status->battery_remaining, sys_status->batery_total, sys_status->batery_capacity, sys_status->batery_used, sys_status->drop_rate_comm, sys_status->errors_comm, sys_status->errors_count1, sys_status->errors_count2, sys_status->errors_count3, sys_status->errors_count4);
}
...
/**
 * @brief Get field batery_total from sys_status message
 *
 * @return [mAh] Total Capacity of Battery, -1: autopilot does not measure the current
 */
static inline uint16_t mavlink_msg_sys_status_get_batery_total(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  18);
}

/**
 * @brief Get field batery_capacity from sys_status message
 *
 * @return [mAh] Current Capacity of Battery, -1: autopilot does not measure the current
 */
static inline uint16_t mavlink_msg_sys_status_get_batery_capacity(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  20);
}

/**
 * @brief Get field batery_used from sys_status message
 *
 * @return [mAh] Used Capacity of Battery, -1: autopilot does not measure the current
 */
static inline uint16_t mavlink_msg_sys_status_get_batery_used(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_sys_status_decode(const mavlink_message_t* msg, mavlink_sys_status_t* sys_status)
{
    ...
    sys_status->batery_total = mavlink_msg_sys_status_get_batery_total(msg);
    sys_status->batery_capacity = mavlink_msg_sys_status_get_batery_capacity(msg);
    sys_status->batery_used = mavlink_msg_sys_status_get_batery_used(msg);
