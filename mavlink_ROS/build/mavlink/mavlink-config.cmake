...
set(mavlink_DIALECTS ASLUAV;ardupilotmega;autoquad;common;icarous;matrixpilot;paparazzi;slugs;standard;uAvionix;ualberta;viam_auv2000)
set(mavlink2_DIALECTS ASLUAV;ardupilotmega;autoquad;common;icarous;matrixpilot;paparazzi;slugs;standard;uAvionix;ualberta;viam_auv2000)

foreach(lib )
  set(onelib "${lib}-NOTFOUND")
  find_library(onelib ${lib}
      PATHS "/home/hai_bker96/VIAM_AUV2000_ROS/mavlink_ROS/devel/lib"
    NO_DEFAULT_PATH
    )
  if(NOT onelib)
